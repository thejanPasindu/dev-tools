...
import { Copy, Check, Trash2, ArrowLeftRight, Link, Link2Off } from 'lucide-react';
        ...
        <div className="h-full flex flex-col bg-background p-6 overflow-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr,auto,1fr] gap-4 items-center flex-1 min-h-0">
                ...
                <div className="flex lg:flex-col gap-2 justify-center py-4 lg:py-0">
                    <button
                        onClick={encode}
                        className="flex items-center gap-2 justify-center px-6 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition-colors shadow-sm"
                    >
                        <Link size={16} /> Encode
                    </button>
                    <button
                    ...
                    <button
                        onClick={decode}
                        className="flex items-center gap-2 justify-center px-6 py-2 bg-secondary text-secondary-foreground rounded-md font-medium hover:bg-secondary/80 transition-colors border"
                    >
                        <Link2Off size={16} /> Decode
                    </button>
                </div>
